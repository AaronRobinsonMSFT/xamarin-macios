...
static int
param_read_primitive (struct ParamIterator *it, const char **type_ptr, void *target, size_t total_size, gpointer *exception_gchandle)
{
...
static void
param_iter_next (enum IteratorAction action, void *context, const char *type, size_t size, void *target, gpointer *exception_gchandle)
{
	// COOP: does not access managed memory: any mode.
...
static void
marshal_return_value (void *context, const char *type, size_t size, void *vvalue, MonoType *mtype, bool retain, MonoMethod *method, MethodDescription *desc, gpointer *exception_gchandle)
{
